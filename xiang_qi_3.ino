...
void loop()
{
  ...
  if (d1 > 60 && d2 > 60 && value1 == 0 && value2 == 0 && value3 == 0 && value4 == 0||attackcount>5)
  {
    if (endcount == 0)
    {
      myrand = random(0, 5);
    ...
    else if ((millis() - starttime) < myrand * 6000)
    {
  ...
  */
  int timer;
  timer=millis();
  if(timer-attackstart>10000&&timer-attackstart<12000||timer-attackstart>20000&&timer-attackstart<23000||timer-attackstart>40000&&timer-attackstart<41000||timer-attackstart>50000&&timer-attackstart<51000){
      wheel1(220);
      wheel2(-220);
      wheel3(-220);
      wheel4(220);
